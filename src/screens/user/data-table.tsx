...
import { ChevronLeft, ChevronRight, Download, Plus, Printer, AlignRight } from "lucide-react"
			...
			<div className="">
				<div className="flex justify-between items-center pb-4">
					...
					<div className="flex items-center space-x-6">
						...
						<Link to="/user/add" className="flex justify-between items-center bg-black py-2.5 pl-2 pr-5 text-white rounded-lg border-2 border-black hover:bg-white hover:text-black hover:border-2 hover:border-black transition-colors duration-400">
